...
std::vector<Experiment> plan_benchmarks(const double target_runtime_sec = 30.0, const double expected_mups_per_core = 1) {
    ...
    const std::vector<size_t> threads = {1,2,4,8,16,32};
